...
lottery = 3  #1
sampling_types = ["random", "weighted", "percentage", "uniform"]  # "random", "weighted", "percentage", "uniform"
...
for dif in difficulty:
    for nt in network_types:
        for st in sampling_types:
            ...
            kwargs = {}
            kwargs["network_type"] = nt  # Options are "MLP" and "SIREN"
            ...
            kwargs["sampling"] = st  # random, weighted, percentage, uniform
            ...
            base_out_dir = os.path.join(current_directory, 'out', 'base', TARGET, f"{kwargs['network_type']}-{kwargs['lr']}-{kwargs['epochs']}-{kwargs['batch_size']}-{kwargs['sampling']}", dif)
