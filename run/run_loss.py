...
for type in network_types:
    for loss in losses:
        for target in targets:
            ...
            kwargs["loss_function"] =  loss #mse, l1, ncc, smoothl1, ssim, huber
            kwargs["lr"] = 0.0001
            ...
            base_out_dir = os.path.join(current_directory, 'out', 'losstype', target, f"{kwargs['network_type']}-{kwargs['lr']}-{kwargs['epochs']}-{kwargs['batch_size']}-{kwargs['sampling']}")
