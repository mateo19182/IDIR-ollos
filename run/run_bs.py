...
for bs in batch_sizes:  
    for nt in network_types:
        ...
        kwargs["lr"] = 0.00005
        kwargs["batch_size"] = bs  #max 1.500.000 ... 16 -> 256 -> 65536
        ...
        base_out_dir = os.path.join(current_directory, 'out', 'bs', TARGET, f"{kwargs['network_type']}-{kwargs['lr']}-{kwargs['epochs']}-{kwargs['batch_size']}")
        ...
        if TARGET == "FIRE":
            ...
            for i in range(14+49, 14+49+70, 2):  #14+49+70, step by 2
