...
dfsimple = np.stack([mapy, mapx], axis=2)#for addressing, easier for me
...
for i in og_points:
	axs[1,0].scatter(i[0]*factor, i[1]*factor,s=1,c='r')

#plot the fixed points obtained from the dfv
for i in moved_points:
	...
	axs[1,0].scatter(xn, yn,s=1,c='b',marker='x')
